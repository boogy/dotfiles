...
myManageHook = composeAll . concat $
    ...
    where
        ...
        myCFloats = [ "Arandr"               , "Places"             , "Nitrogen"          , "feh"             , "mpv"                ,
                      ...
                      "Nm-connection-editor" , "Gnome-calculator"   , "Eog"               , "Piper"           , "Seahorse"           ,
                      "Evince"               , "VirtualBox Manager" , "Xfce4-taskmanager" , "Xfce4-appfinder" , "org.remmina.Remmina",
        ...
        my6Shifts = ["Sofice", "libreoffice", "Libreoffice", "libreoffice-writer", "libreoffice-calc"]
        my7Shifts = []
        my8Shifts = []
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    , ((mySup .|. shiftMask,   xK_e),      screenWorkspace 1 >>= flip whenJust (windows . (W.greedyView)))
